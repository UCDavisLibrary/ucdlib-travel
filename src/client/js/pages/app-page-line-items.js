...
import { render } from "./app-page-line-items.tpl.js";
import { LitCorkUtils, Mixin } from "../../../lib/appGlobals.js";
import { MainDomElement } from "@ucd-lib/theme-elements/utils/mixins/main-dom-element.js";


export default class AppPageLineItems extends Mixin(LitElement)
  ...
  constructor() {
    ...
    this._injectModel('AppStateModel', 'LineItemsModel');
  }
  ...
  async getPageData(){
    const promises = [];
    promises.push(this.LineItemsModel.getFoo());
...
customElements.define('app-page-line-items', AppPageLineItems);
