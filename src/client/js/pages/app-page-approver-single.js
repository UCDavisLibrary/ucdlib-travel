...
import { render } from "./app-page-approver-single.tpl.js";
import { LitCorkUtils, Mixin } from "../../../lib/appGlobals.js";
import { MainDomElement } from "@ucd-lib/theme-elements/utils/mixins/main-dom-element.js";


export default class AppPageApproverSingle extends Mixin(LitElement)
  ...
  async _onAppStateUpdate(state) {
    ...
    this.AppStateModel.setTitle('Approver Single');
...
customElements.define('app-page-approver-single', AppPageApproverSingle);
