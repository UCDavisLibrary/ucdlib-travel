...
import { render } from "./app-page-settings.tpl.js";
import { LitCorkUtils, Mixin } from "../../../lib/appGlobals.js";
import { MainDomElement } from "@ucd-lib/theme-elements/utils/mixins/main-dom-element.js";


export default class AppPageSettings extends Mixin(LitElement)
  ...
  async getPageData(){
    const promises = [];
    promises.push(this.SettingsModel.getFoo());
...
customElements.define('app-page-settings', AppPageSettings);
